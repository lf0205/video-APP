<template>
	<view class="page">
		<view class="cover-view-center" v-if="distanceX==0">
			<view :style="{ height: height,width: width }" ref="touch" @click="videoPlay(index)" @touchstart="ListTouchStart" @touchmove="ListTouchMove">
				<view class="cover-view-right" v-if="distanceX==0">
		...
		<view class="left-div" :style="{ height: height,width: width,left:`${-parseInt(width)}px` }" ref="left"  @touchstart="ListTouchStart" @touchmove="ListTouchMove">
			<text class="title-text" @click="clickbt">{{videoList[index].at}}</text>
		</view>
		<view class="right-div" :style="{ height: height,width: width,right:`${-parseInt(width)}px` }" ref="right"  @touchstart="ListTouchStart" @touchmove="ListTouchMove">
